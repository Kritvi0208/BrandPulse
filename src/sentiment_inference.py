...
class SentimentClassifier:
    def __init__(self, bert_path=None, threshold=0.5, **kwargs):
        ...
        if bert_path is not None and os.path.exists(bert_path):
            ...
            print(f"Warning: Checkpoint at {bert_path} not found. Using pre-trained ganeshkharad/gk-hinglish-sentiment weights.")
